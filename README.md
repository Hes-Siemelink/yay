...
Tag latest commit with the version that was produced, e.g. `yay-0.9`.
...
Now update the version in `setup.py` to reflect the new version, e.g. `0.10-SNAPSHOT` and commit. Don't forget to push the tag...
